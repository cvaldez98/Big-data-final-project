import sys
sys.path.append('../')
#import training.data_collection_training as data_collection_training
from training.train_svm import classifier
from training.train_svm import vectorizer 
import data_collection_eval
...
#x_train = training.train_svm.x_train
#y_train = training.train_svm.y_train
tf_lsvm = classifier()
tf_vect = vectorizer()
